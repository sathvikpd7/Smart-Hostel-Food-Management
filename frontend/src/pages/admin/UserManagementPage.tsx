          ...
          <div className="bg-white rounded-lg w-full max-w-lg">
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="add-student-role">Role</label>
                  <select
                    id="add-student-role"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1" htmlFor="add-student-status">Status</label>
                  <select
