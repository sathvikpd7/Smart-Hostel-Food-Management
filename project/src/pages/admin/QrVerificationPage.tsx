...
const QrVerificationPage: React.FC = () => {
  ...
  const handleVerifyQrCode = (code: string = qrCode) => {
    if (!code.trim()) {
    ...
    const booking = bookings.find(b => b.qrCode === code);
        ...
        <div className="col-span-1 md:col-span-8">
          <Card>
            ...
            <CardContent>
              ...
              {cameraActive && (
                <div className="mb-6">
                  <div id="qr-reader" className="w-full min-h-[500px]"></div>
                </div>
              )}
            ...
            <CardContent>
              {verificationResult ? (
                  ...
                  {verificationResult.booking && (
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <p className="font-medium">{formatMealType(verificationResult.booking.type)}</p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500">Date</p>
                        <p className="font-medium">{new Date(verificationResult.booking.date).toLocaleDateString()}</p>
                      </div>
                ...
                <div className="text-center text-gray-500 py-8">
                  ...
                  <p>Scan or enter a QR code to verify</p>
                </div>
              )}
            </CardContent>
          </Card>
